...
WPA_SUPPL_TERM_CMD = "wpa_cli -i DEV_NAME terminate"
...
class MainWindow(Gtk.Window):
    ...
    def close_root_window(self, signal):
        # terminate wpa_supplicant if wifi is off
        if not check_wlan_state():
            run(WPA_SUPPL_TERM_CMD.replace("DEV_NAME", self.interface), shell=True)
